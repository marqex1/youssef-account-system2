...
function renderLogin(){
  app.innerHTML=`<div class="login-wrap"><form class="login-card" onsubmit="login(event)">
    <img class="logo" src="./assets/logo.jpeg" alt="Youssef" onerror="this.outerHTML='<div class=&quot;logo-fallback&quot;>YM</div>'">
    ...
    <p class="login-sub" style="margin-top:14px">Version 22 Mobile Fix</p>
  </form></div>`;
}
